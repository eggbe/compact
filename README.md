...
Sometimes it's important to make class overloading during the deserialization process. The second parameter of ```Compactor::decompact()``` provids the simplest way to do it. 
